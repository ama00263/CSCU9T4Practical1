...
public class SwimEntryTest {
    ...
    public void testGetName() {
        ...
        Entry instance = new Swim("Alice", 1, 2, 2003, 0, 16, 7, 3,"outdoors");
    ...
    public void testGetWhere() {
        ...
        Entry instanceA = new Swim("Alice", 1, 2, 2003, 0, 16, 7, 3,"outdoors");
        String expResultA = "outdoors";
        String result = instanceA.getWhere();
        assertEquals(expResultA, result);
        
        Entry instanceB = new Swim("Alice", 1, 2, 2003, 0, 16, 7, 3,"pool");
